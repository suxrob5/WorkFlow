...
const Modal = ({ open, onClose, modalData }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-md dark:bg-black">
      <div className="w-full max-w-4xl overflow-hidden rounded-3xl border border-slate-200/60 bg-white/80 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-black">
