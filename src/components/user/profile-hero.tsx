    ...
    <div className="w-full rounded-3xl bg-white/60 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 backdrop-blur-xl shadow-[0_25px_50px_rgba(0,0,0,0.06)] dark:shadow-[0_25px_50px_rgba(0,0,0,0.35)] overflow-hidden mb-8 transition-all duration-300">
      ...
      <div className="px-6 pb-6 pt-0 relative flex flex-col md:flex-row md:flex-wrap md:items-end justify-between gap-6 -mt-16 md:-mt-20">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-5 text-center md:text-left flex-1 min-w-0">
          ...
          <div className="relative group w-32 h-32 md:w-36 md:h-36 rounded-full p-1.5 bg-linear-to-tr from-sky-400 via-indigo-500 to-blue-600 shadow-[0_10px_35px_rgba(14,165,233,0.2)] dark:shadow-[0_10px_35px_rgba(14,165,233,0.3)] transition duration-300 hover:scale-[1.03] shrink-0">
          ...
          <div className="mb-2 min-w-0 flex-1">
            <div className="flex flex-col md:flex-row md:flex-wrap items-center gap-3">
              ...
              <span className="px-3 py-1 text-xs font-bold tracking-wider text-sky-600 dark:text-sky-300 bg-sky-500/10 border border-sky-450/20 dark:border-sky-400/30 rounded-full flex items-center gap-1.5 uppercase shadow-inner shrink-0">
          ...
          {!isEditing ? (
            <>
              ...
              <button
                ...
                className="bg-red-500/10 dark:bg-red-500/5 border border-red-500/20 hover:border-red-500/40 hover:bg-red-500/15 text-red-600 dark:text-red-400 font-bold px-6 py-2.5 rounded-2xl shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] flex items-center gap-2 cursor-pointer"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
