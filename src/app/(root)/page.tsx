      ...
      <main className="relative z-10 mx-auto max-w-4xl px-4 py-8 md:px-6">
        ...
        <div className="text-center md:text-left mb-8 space-y-2">
          ...
          <p className="text-sm md:text-base text-slate-600 dark:text-slate-400 font-medium max-w-xl">
            Зарегистрируйте свое присутствие, сделав отметку с помощью
            встроенной камеры вашего устройства и геопозиции.
          </p>
        </div>
            ...
            <div className="py-8 space-y-6 flex flex-col items-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-sm mx-auto leading-relaxed">
                  Программа запросит доступ к фронтальной камере для снимка и
                  запишет текущие координаты GPS для сверки.
                </p>
              </div>
